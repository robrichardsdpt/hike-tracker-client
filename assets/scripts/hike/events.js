...
const onShowByTrails = function (event) {
  ...
  const filteredHikes = store.hikes.filter(hike => hike.trails.toLowerCase().includes(trails.toLowerCase()) || hike.mountainsClimbed.toLowerCase().includes(trails.toLowerCase()) || hike.hikedWith.toLowerCase().includes(trails.toLowerCase()) || hike.trailNotes.toLowerCase().includes(trails.toLowerCase()))
